...
class TransportMapView: UIViewController {
    //==================
    // кастом audio
    var player:AVPlayer?
    ...
    //
    let managerGeocoder =  NMAGeocoder.sharedInstance()
    ...
    func addLayerConfig() {
        ...
        fromPointButton.isHidden = true
        // to point
        toPointButton.setTitle(/*"To"*/"Show ", for: .normal)
        ...
        // reset route
        resetRouteButton.setTitle("AR", for: .normal)
    ...
    @objc func resetRouteAction(_ sender : UIButton) {
        ...
        //player!.play()
        guard let url = Bundle.main.url(forResource: "bus", withExtension: "m4a") else {
              return
          }
    ...
    */
    ...
    override func viewWillAppear(_ animated: Bool) {
           ...
           if tabBarTag == true {
               ...
               self.tabBarController?.tabBar.tintColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)//UIColor.white
           }
    }
...
extension TransportMapView : NMAMapGestureDelegate,NMAMapViewDelegate,NMATransitManagerDelegate {
    
}
extension TransportMapView : CLLocationManagerDelegate {
